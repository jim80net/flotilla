...
standby with the authorized queue drained. The live fleet is the Spark/General-ML deployment;
the live roster + state live under `/home/jim/workspace/github.com/General-ML/spark/state/`,
NOT in this repo.
