...
`/home/jim/workspace/github.com/jim80net/flotilla`). The live fleet is the Spark/your-org
deployment; the live roster + state live at
`/home/jim/workspace/github.com/your-org/your-repo/state/` (flotilla.json, fleet-backlog.md, the
