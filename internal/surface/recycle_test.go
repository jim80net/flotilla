...
func TestClaudeHandoffPath(t *testing.T) {
	c := newClaudeCode()
	got := c.HandoffPath("/home/operator/fleet", "20260623T141530.000000001-a3f91b2c")
	want := "/home/operator/fleet/.claude/handoffs/recycle-20260623T141530.000000001-a3f91b2c.md"
	if got != want {
...
func TestGrokHandoffPath(t *testing.T) {
	g := newGrok()
	got := g.HandoffPath("/home/operator/fleet", "20260623T141530.000000001-a3f91b2c")
	want := "/home/operator/fleet/.flotilla/handoffs/recycle-20260623T141530.000000001-a3f91b2c.md"
	if got != want {
...
// remote-driven, and references NO claude/desk-l skill (grok has no /handoff skill).
