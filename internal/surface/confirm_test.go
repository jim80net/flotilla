...
func TestConfirmSubmitPendingAfterRetriesIsBlocked(t *testing.T) {
	// THE authority (the beta-xo case): the body provably REMAINS in the composer through the
...
func TestConfirmSubmitQueuedIsSoftSuccess(t *testing.T) {
	// The alpha-xo case: after submitting, the composer enters the QUEUED state ("Press up to edit
