...
func deliverOrQueueSend(cfg *roster.Config, rosterPath, sender, recipient string, drv surface.Driver, pane, message string) (queued bool, err error) {
	return deliverOrQueueSendWith(cfg, rosterPath, sender, recipient, pane, message, func() error {
		return deliverSendWithRetry(drv, pane, recipient, message)
	})
}

func deliverOrQueueSendWith(cfg *roster.Config, rosterPath, sender, recipient, pane, message string, deliverNow func() error) (queued bool, err error) {
