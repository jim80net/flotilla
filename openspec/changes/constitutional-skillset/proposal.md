...
substrate does NOT exist as running code. alpha-xo **ratified a SPLIT (2026-06-21)**:
...
## Rejected alternatives (the primary-home question — surface to alpha-xo at ratification)
...
- **Affected code (implement phase, after the trio + alpha-xo ratify):** new `assets/skills/`
