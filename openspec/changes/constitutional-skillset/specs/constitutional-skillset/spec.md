...
one member — the Rule of Three (span of control) — and leaves a clean, member-count-agnostic seam
for the operator to add more (the visibility-synthesis member is the separate forthcoming B2 change,
re-designed around a local substrate, and is NOT part of this capability's v1).
