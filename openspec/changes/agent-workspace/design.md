...
```json
{ "launch": "claude --append-system-prompt-file ~/.flotilla/xo/CLAUDE.md -w xo", "cwd": "/abs/worktree", "tmux": "flotilla:xo" }
```
...
- Switching the tracker source (operator `mv .flotilla-state.md ~/.flotilla/xo/state.md`)
