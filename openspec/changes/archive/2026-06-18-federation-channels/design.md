...
every per-channel side-conversation and integrates "who-knows-what" context. A private deployment's fleet already does this by hand in an operational `state/context-ledger.md`;
