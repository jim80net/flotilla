...
- [x] 9.4 PR → merge → deploy as `flotilla-watch.service`; archive this change. (PR #2 merged ✅; deployed clock-only then RELAY enabled 2026-06-03 ✅ — gateway connected to #c2, inbound relay active; archiving now.)
