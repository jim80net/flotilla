...
blocked`, followed by the secondary `accepts-dispatch` count. Authority waits
remain available capacity on operator surfaces; their raw posture is retained
only on the per-seat diagnostic record. Blocked is an overlay
