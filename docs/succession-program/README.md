...
CoS/XO seats that do not depend on Claude/Fable subscriptions.

**flotilla-dev owns:** harness + seat plumbing (drivers, workspace init, trial desks, readiness).
...
**Gates:** design/readiness docs → operator/CoS gate. **No live CoS/XO seat swaps** without an
