...
FLOTILLA_DASH_WORKDIR='' FLOTILLA_DASH_BIN='' FLOTILLA_DASH_ROSTER='' FLOTILLA_DASH_BIND='' FLOTILLA_DASH_REPO='' FLOTILLA_DASH_SECRETS='' FLOTILLA_DASH_TRACKER_FILE='' FLOTILLA_DASH_BACKLOG_FILE=''
...
for v in FLOTILLA_DASH_WORKDIR FLOTILLA_DASH_BIN FLOTILLA_DASH_ROSTER FLOTILLA_DASH_BIND FLOTILLA_DASH_REPO FLOTILLA_DASH_SECRETS FLOTILLA_DASH_TRACKER_FILE FLOTILLA_DASH_BACKLOG_FILE; do
  if [[ "${!v}" == *@FLOTILLA_*@* ]]; then
...
# OPTIONAL --repo / --secrets / --tracker-file / --backlog-file: compute each
# ExecStart fragment. SET ⇒ " --flag <val>"
...
if [[ -n "$FLOTILLA_DASH_TRACKER_FILE" ]]; then tracker_arg=" --tracker-file $FLOTILLA_DASH_TRACKER_FILE"; else tracker_arg=""; fi
...
content="${content//@FLOTILLA_DASH_TRACKER_ARG@/$tracker_arg}"
...
[[ -z "$FLOTILLA_DASH_TRACKER_FILE" ]] || check_path "$FLOTILLA_DASH_TRACKER_FILE" || \
  echo "warning: history tracker not found yet: $FLOTILLA_DASH_TRACKER_FILE (history remains empty until it exists)" >&2
